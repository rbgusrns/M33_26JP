...
;* Date/Time created: Thu Jul 02 08:45:28 2026                 *
;***************************************************************
...
DW$6	.dwtag  DW_TAG_subprogram, DW_AT_name("SCIx_TxChar"), DW_AT_symbol_name("_SCIx_TxChar")
	...
	.dwattr DW$6, DW_AT_begin_line(0x4e)
...
;***	-----------------------g2:
;*** 82	-----------------------    if ( !(*((volatile struct _SCICTL2_BITS *)&SciaRegs+4L)&0x80u) ) goto g2;
	.dwpsn	"DSP280x_Sci.c",82,11
        MOVW      DP,#_SciaRegs+4
        TBIT      @_SciaRegs+4,#7       ; |82| 
        BF        L1,NTC                ; |82| 
        ; branchcc occurs ; |82| 
DW$L$_SCIx_TxChar$2$E:
;*** 83	-----------------------    SciaRegs.SCITXBUF = Data;
;*** 83	-----------------------    return;
	.dwpsn	"DSP280x_Sci.c",83,5
        MOV       @_SciaRegs+9,AL       ; |83| 
	.dwpsn	"DSP280x_Sci.c",84,1
        LRETR
        ; return occurs

DW$9	.dwtag  DW_TAG_loop
	.dwattr DW$9, DW_AT_name("C:\project\Linetracer\_Vistan_\main\DSP280x_Sci.asm:L1:1:1782949528")
	.dwattr DW$9, DW_AT_begin_file("DSP280x_Sci.c")
	.dwattr DW$9, DW_AT_begin_line(0x52)
	.dwattr DW$9, DW_AT_end_line(0x52)
DW$10	.dwtag  DW_TAG_loop_range
	...
	.dwattr DW$6, DW_AT_end_line(0x54)
...
DW$11	.dwtag  DW_TAG_subprogram, DW_AT_name("SCIx_TxString"), DW_AT_symbol_name("_SCIx_TxString")
	...
	.dwattr DW$11, DW_AT_begin_line(0x56)
...
;***	-----------------------g5:
;*** 82	-----------------------    if ( !(*((volatile struct _SCICTL2_BITS *)&SciaRegs+4L)&0x80u) ) goto g5;  // [3]
	.dwpsn	"DSP280x_Sci.c",82,11
        MOVW      DP,#_SciaRegs+4
        TBIT      @_SciaRegs+4,#7       ; |82| 
        BF        L3,NTC                ; |82| 
...
;*** 83	-----------------------    SciaRegs.SCITXBUF = 13u;  // [3]
	.dwpsn	"DSP280x_Sci.c",83,5
        MOV       @_SciaRegs+9,#13      ; |83| 
...
;*** 94	-----------------------    Data = U$1;
;***  	-----------------------    #pragma LOOP_FLAGS(4096u)
	.dwpsn	"DSP280x_Sci.c",94,9
DW$L$_SCIx_TxString$5$E:
L5:    
DW$L$_SCIx_TxString$6$B:
;***	-----------------------g8:
;*** 82	-----------------------    if ( !(*((volatile struct _SCICTL2_BITS *)&SciaRegs+4L)&0x80u) ) goto g8;  // [3]
	.dwpsn	"DSP280x_Sci.c",82,11
        MOVW      DP,#_SciaRegs+4
        TBIT      @_SciaRegs+4,#7       ; |82| 
        BF        L5,NTC                ; |82| 
...
;*** 83	-----------------------    SciaRegs.SCITXBUF = Data;  // [3]
;*** 83	-----------------------    if ( U$1 = *(++Str) ) goto g3;  // [3]
;***	-----------------------g10:
;***  	-----------------------    return;
	.dwpsn	"DSP280x_Sci.c",83,5
        MOV       @_SciaRegs+9,AL       ; |83| 
...
DW$16	.dwtag  DW_TAG_loop
	.dwattr DW$16, DW_AT_name("C:\project\Linetracer\_Vistan_\main\DSP280x_Sci.asm:L2:1:1782949528")
	.dwattr DW$16, DW_AT_begin_file("DSP280x_Sci.c")
	.dwattr DW$16, DW_AT_begin_line(0x53)
	.dwattr DW$16, DW_AT_end_line(0x5f)
...
DW$21	.dwtag  DW_TAG_loop
	.dwattr DW$21, DW_AT_name("C:\project\Linetracer\_Vistan_\main\DSP280x_Sci.asm:L3:2:1782949528")
	.dwattr DW$21, DW_AT_begin_file("DSP280x_Sci.c")
	.dwattr DW$21, DW_AT_begin_line(0x52)
	.dwattr DW$21, DW_AT_end_line(0x5a)
...
DW$23	.dwtag  DW_TAG_loop
	.dwattr DW$23, DW_AT_name("C:\project\Linetracer\_Vistan_\main\DSP280x_Sci.asm:L5:2:1782949528")
	.dwattr DW$23, DW_AT_begin_file("DSP280x_Sci.c")
	.dwattr DW$23, DW_AT_begin_line(0x52)
...
DW$24	.dwtag  DW_TAG_loop_range
	...
	.dwattr DW$11, DW_AT_end_line(0x60)
...
_TxPrintf:
;*** 102	-----------------------    C$1 = &Buff[0];
;*** 102	-----------------------    vsprintf(C$1, (char *)Form, (char *)(&Form));
;*** 104	-----------------------    SCIx_TxString(C$1);
;*** 104	-----------------------    return;
	.dwcfa	0x1d, -2
	.dwcfa	0x1c, 26, 0
	.dwcfa	0x09, 40, 26
...
DW$29	.dwtag  DW_TAG_variable, DW_AT_name("C$1"), DW_AT_symbol_name("C$1")
	...
	.dwpsn	"DSP280x_Sci.c",102,5
        ...
        MOVL      *-SP[2],XAR4          ; |102| 
        MOVL      XAR5,*-SP[8]          ; |102| 
        MOVL      XAR3,#_Buff$1$0       ; |102| 
        MOVL      XAR4,XAR3             ; |102| 
        LCR       #_vsprintf            ; |102| 
        ; call occurs [#_vsprintf] ; |102| 
	.dwpsn	"DSP280x_Sci.c",104,5
        MOVL      XAR4,XAR3             ; |104| 
        LCR       #_SCIx_TxString       ; |104| 
        ; call occurs [#_SCIx_TxString] ; |104| 
	...
	.dwattr DW$25, DW_AT_end_line(0x69)
...
DW$30	.dwtag  DW_TAG_subprogram, DW_AT_name("SCIx_RxChar"), DW_AT_symbol_name("_SCIx_RxChar")
	...
	.dwattr DW$30, DW_AT_begin_line(0x46)
	.dwattr DW$30, DW_AT_begin_column(0x06)
	.dwpsn	"DSP280x_Sci.c",71,1
...
;***	-----------------------g2:
;*** 74	-----------------------    if ( !(*((volatile struct _SCIRXST_BITS *)&SciaRegs+5L)&0x40u) ) goto g2;
	.dwpsn	"DSP280x_Sci.c",74,12
        MOVW      DP,#_SciaRegs+5
        TBIT      @_SciaRegs+5,#6       ; |74| 
        BF        L7,NTC                ; |74| 
        ; branchcc occurs ; |74| 
DW$L$_SCIx_RxChar$2$E:
;*** 75	-----------------------    return (int)SciaRegs.SCIRXBUF.all;
	.dwpsn	"DSP280x_Sci.c",75,5
        MOV       AL,@_SciaRegs+7       ; |75| 
	.dwpsn	"DSP280x_Sci.c",76,1
        LRETR
        ; return occurs

DW$31	.dwtag  DW_TAG_loop
	.dwattr DW$31, DW_AT_name("C:\project\Linetracer\_Vistan_\main\DSP280x_Sci.asm:L7:1:1782949528")
	.dwattr DW$31, DW_AT_begin_file("DSP280x_Sci.c")
	.dwattr DW$31, DW_AT_begin_line(0x4a)
	.dwattr DW$31, DW_AT_end_line(0x4a)
DW$32	.dwtag  DW_TAG_loop_range
	...
	.dwattr DW$30, DW_AT_end_line(0x4c)
...
;*** 58	-----------------------    C$1 = &SciaRegs;
;*** 58	-----------------------    *((volatile struct _SCICTL2_BITS *)C$1+4L) &= 0xfffdu;
;*** 59	-----------------------    *((volatile struct _SCICTL2_BITS *)C$1+4L) &= 0xfffeu;
;*** 61	-----------------------    SciaRegs.SCIFFTX.all = 0xa000u;
;*** 62	-----------------------    SciaRegs.SCIFFCT.all = 16384u;
;*** 66	-----------------------    *((volatile struct _SCICTL1_BITS *)C$1+1L) |= 0x20u;
;*** 66	-----------------------    return;
	.dwcfa	0x1d, -2
	.dwcfa	0x1c, 26, 0
	.dwcfa	0x09, 40, 26
...
DW$34	.dwtag  DW_TAG_variable, DW_AT_name("C$1"), DW_AT_symbol_name("C$1")
	...
	.dwattr DW$33, DW_AT_end_line(0x44)
